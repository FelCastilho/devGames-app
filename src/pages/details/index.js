    ...
    useEffect(() => {
        ...
        async function loadDetails() {
            ...
            try {
                ...
                const isFavorited = await checkIfFavorited(data.id);
            ...
            <Container>
                ...
                <ContainerBanner>
                    ...
                    <ContainerButtons>
                        ...
                        {isFavorited ? <Ionicons name="bookmark" size={24} color="white" /> : <Ionicons name="bookmark-outline" size={24} color="white" />}
                        </FavoriteButton>
